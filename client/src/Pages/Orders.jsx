        ...
        <>
            <div className='w-screen bg-[#efefef] '>
                ...
                <div className='w-full bodytext '>
                    <div className='w-screen  h-[50px] ss:h-[60px] sl:h-[65px] f:h-[79px]'></div>
                    {
                        isLoggedIn
                            ?
                            <div>
                                ...
                                <div className='pt-10 px-5  s:px-[14vw]'>
                                    {
                                        allOrders.length == 0
                                            ...
                                            <div className='w-full h-[70vh] flex justify-center items-center'>
                                                <div>
                                                    <h1 className='text-[20px] bodytext'>Looks like you haven't placed an order!!</h1>
                                                    <div className='w-full text-center mt-4'>
                                                        <Link to={'/shop'} className='text-center px-8 py-2 text-[14px] uppercase bg-[#1D0100] text-white'>Shop Now</Link>
                                                    </div>
                                                </div>
                                            </div>
                                            :
