...
const ExchangePolicy = () => {
  return (
    <div className='w-screen px-10 ss:px-20 py-5'>
...
Conditions for Exchange<br/>
Exchanges are only available for products with manufacturing defects.<br/>
The product must be unused, unwashed, and in its original condition with all tags and packaging intact.<br/>
We reserve the right to refuse exchanges if the product is found to be damaged due to improper use or handling.<br/>
Contact Us<br/>
