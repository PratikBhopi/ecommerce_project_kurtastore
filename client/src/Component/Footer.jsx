...
const Footer = () => {
  return (
    <>
      ...
      <div className='subtextLines text-yellow-600  px-2 py-2 text-[20px]'><Link to={'/home'}><span className='QuoteLines'>K</span>arma <span className='QuoteLines'>T</span>hreads</Link></div>
      ...
      <div className='w-screen flex justify-center py-3 text-center tracking-[1px] bg-white text-black text-[11px] ss:text-[14px]'>Copyright 2024 © KARMA THREADS | All Rights Reserved </div>
    </>
  )
}
